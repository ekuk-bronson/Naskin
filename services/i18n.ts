...
const dict: Record<Locale, Record<string, string>> = {
  ru: {
    ...
    // ABCDE card (labels + per-bucket notes; stored in DB as keys, localized at render)
    'abcde.lbl.asymmetry':   'A · Асимметрия',
    'abcde.lbl.border':      'B · Границы',
    'abcde.lbl.color':       'C · Цвет',
    'abcde.lbl.diameter':    'D · Диаметр',
    'abcde.lbl.evolution':   'E · Изменение',
    'abcde.asymmetry.0':     'Симметричная',
    'abcde.asymmetry.1':     'Лёгкая асимметрия',
    'abcde.asymmetry.2':     'Выраженная по двум осям',
    'abcde.border.0':        'Чёткие ровные края',
    'abcde.border.1':        'Края слегка размыты',
    'abcde.border.2':        'Нечёткие неровные края',
    'abcde.color.0':         'Однородный',
    'abcde.color.1':         'Неоднородный',
    'abcde.color.2':         'Неоднородный тёмный',
    'abcde.diameter.0':      'Небольшая в кадре',
    'abcde.diameter.1':      'Средняя в кадре',
    'abcde.diameter.2':      'Крупная в кадре',
    'abcde.evolution.0':     'Без изменений',
    'abcde.evolution.1':     'Небольшие изменения',
    'abcde.evolution.2':     'Рост за последние месяцы',
    'abcde.evo.first':       'Появится после повторного скана',
    'abcde.evo.stable':      'Стабильно с прошлого замера',
    'abcde.evo.up':          'Показатель вырос с прошлого замера',
    'abcde.evo.down':        'Показатель снизился с прошлого замера',
  ...
  en: {
    ...
    // ABCDE card (labels + per-bucket notes; stored in DB as keys, localized at render)
    'abcde.lbl.asymmetry':   'A · Asymmetry',
    'abcde.lbl.border':      'B · Border',
    'abcde.lbl.color':       'C · Color',
    'abcde.lbl.diameter':    'D · Diameter',
    'abcde.lbl.evolution':   'E · Evolution',
    'abcde.asymmetry.0':     'Symmetrical',
    'abcde.asymmetry.1':     'Slight asymmetry',
    'abcde.asymmetry.2':     'Pronounced along both axes',
    'abcde.border.0':        'Sharp, even edges',
    'abcde.border.1':        'Slightly blurred edges',
    'abcde.border.2':        'Fuzzy, irregular edges',
    'abcde.color.0':         'Uniform color',
    'abcde.color.1':         'Uneven color',
    'abcde.color.2':         'Uneven, dark areas',
    'abcde.diameter.0':      'Small in frame',
    'abcde.diameter.1':      'Medium in frame',
    'abcde.diameter.2':      'Large in frame',
    'abcde.evolution.0':     'No change',
    'abcde.evolution.1':     'Minor changes',
    'abcde.evolution.2':     'Growth in recent months',
    'abcde.evo.first':       'Available after a repeat scan',
    'abcde.evo.stable':      'Stable since the last scan',
    'abcde.evo.up':          'Score increased since the last scan',
    'abcde.evo.down':        'Score decreased since the last scan',
