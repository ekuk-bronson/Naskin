...
const styles = StyleSheet.create({
  ...
  topBarTitle:    { fontSize: 13, fontFamily: Font.bodyMed, color: DARK, letterSpacing: 0.2 },
  content:        { paddingHorizontal: 24, paddingTop: 28, paddingBottom: 120 },
  heading:        { fontSize: 28, fontFamily: Font.display, color: DARK, letterSpacing: -0.8, marginBottom: 24 },
  subLabel:       { fontSize: 10, fontFamily: Font.bodySemiBold, color: FAINT, letterSpacing: 2.2, textTransform: 'uppercase', marginBottom: 10 },
  ...
  ctaBtnText:     { fontSize: 14, fontFamily: Font.bodySemiBold, color: '#F0EDE8', letterSpacing: 0.3 },
  previewWrapper: { alignItems: 'center', marginBottom: 20 },
  preview:        { borderRadius: 0, overflow: 'hidden' },
  retakeBtn:      { marginTop: 12 },
  retakeBtnText:  { fontSize: 12, color: STONE, fontFamily: Font.bodyMed, letterSpacing: 0.2 },
  ...
  photoBtnPrimaryText:   { fontSize: 14, fontFamily: Font.bodySemiBold, color: '#F0EDE8', letterSpacing: 0.3 },
  photoBtnSecondary:     { backgroundColor: '#fff', borderWidth: 1, borderColor: BORDER },
  photoBtnSecondaryText: { fontSize: 14, fontFamily: Font.bodySemiBold, color: DARK, letterSpacing: 0.3 },
  ...
  qOk:              { fontSize: 12, color: '#00904A', fontFamily: Font.bodyMed, flex: 1, marginTop: 1 },
  qTitle:           { fontSize: 12, fontFamily: Font.bodySemiBold, color: '#E06000', letterSpacing: 0.1, marginBottom: 3 },
  qBody:            { fontSize: 12, color: DARK, lineHeight: 17 },
  qActions:         { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 8 },
  qLink:            { fontSize: 12, color: STONE, fontFamily: Font.bodySemiBold, letterSpacing: 0.2 },
  ...
  demoText:         { fontSize: 11, fontFamily: Font.bodyMed, color: STONE, letterSpacing: 0.3 },
  ...
  analyzeTitle:   { fontSize: 20, fontFamily: Font.bodySemiBold, color: DARK, letterSpacing: -0.4, marginBottom: 8 },
