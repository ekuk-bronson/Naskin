...
const s = StyleSheet.create({
  ...
  headerSup:       { fontSize: 9, color: STONE, letterSpacing: 2.2, textTransform: 'uppercase', fontFamily: Font.bodyMed, marginBottom: 4 },
  headerTitle:     { fontSize: 26, fontFamily: Font.display, color: DARK, letterSpacing: -0.8 },
  ...
  heroSup:         { fontSize: 9, color: '#5A5248', letterSpacing: 2.0, textTransform: 'uppercase', fontFamily: Font.bodyMed, marginBottom: 8 },
  heroCount:       { fontSize: 54, fontFamily: Font.display, color: '#F0EDE8', letterSpacing: -2, lineHeight: 56, marginBottom: 6 },
  ...
  heroRingPct:     { fontSize: 17, fontFamily: Font.display, color: STONE, letterSpacing: -0.5, lineHeight: 20 },
  ...
  heroBadgeNum:    { fontSize: 21, fontFamily: Font.display, letterSpacing: -0.5, lineHeight: 22, textAlign: 'center' },
  ...
  alertTitle:      { fontSize: 12, color: '#E8003D', fontFamily: Font.bodySemiBold, marginBottom: 2 },
  ...
  sectionLabel:    { fontSize: 9, color: FAINT, letterSpacing: 2, textTransform: 'uppercase', fontFamily: Font.bodyMed },
  sortBtn:         { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 99, backgroundColor: '#fff', borderWidth: 1, borderColor: '#EDE9E3' },
  sortBtnText:     { fontSize: 10, color: STONE, fontFamily: Font.bodyMed, letterSpacing: 0.3 },
  // Empty
  ...
  emptyTitle:      { fontSize: 15, fontFamily: Font.bodySemiBold, color: DIM, letterSpacing: -0.2 },
  ...
  moleName:        { fontSize: 13, fontFamily: Font.bodySemiBold, color: DARK, letterSpacing: -0.3, flexShrink: 1 },
  ...
  moleRiskText:    { fontSize: 11, fontFamily: Font.bodySemiBold, letterSpacing: 0.2 },
  // Swipe delete
  ...
  deleteLabel:     { fontSize: 9, fontFamily: Font.bodySemiBold, color: '#fff', letterSpacing: 0.4 },
  // Footer
  ...
  addBtnText:      { fontSize: 14, fontFamily: Font.bodySemiBold, color: '#F0EDE8', letterSpacing: 0.3 },
});
