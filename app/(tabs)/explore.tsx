...
const styles = StyleSheet.create({
  ...
  sup:              { fontSize: 9, color: STONE, letterSpacing: 2.2, fontFamily: Font.bodyMed, textTransform: 'uppercase', marginBottom: 4 },
  title:            { fontSize: 28, fontFamily: Font.display, color: DARK, letterSpacing: -0.8 },
  subtitle:         { fontSize: 11, color: FAINT, marginTop: 3 },
  scroll:           { flex: 1 },
  content:          { paddingHorizontal: 16, paddingBottom: 36 },
  sectionHeader:    { fontSize: 9, color: FAINT, letterSpacing: 2.0, textTransform: 'uppercase', fontFamily: Font.bodyMed, marginTop: 22, marginBottom: 8, marginLeft: 2 },
  ...
  rowLeft:          { flex: 1 },
  rowLabel:         { fontSize: 14, color: DARK, fontFamily: Font.bodyMed, letterSpacing: -0.1 },
  ...
  chipTextActive:   { fontSize: 12, color: '#F0EDE8', fontFamily: Font.bodyMed },
  ...
  appInfoLeft:      {},
  appInfoAppName:   { fontSize: 18, fontFamily: Font.display, color: DARK, letterSpacing: -0.6 },
  appInfoAppSub:    { fontSize: 9, color: STONE, letterSpacing: 2.0, textTransform: 'uppercase', fontFamily: Font.bodyMed, marginTop: 3 },
  appInfoRight:     { alignItems: 'flex-end' },
  appInfoVersion:   { fontSize: 12, color: DARK, fontFamily: Font.bodyMed },
