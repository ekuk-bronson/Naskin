...
const s = StyleSheet.create({
  ...
  avatarInit:{ fontSize: 20, fontFamily: Font.display, color: '#F0EDE8' },
  userName:  { fontSize: 13, fontFamily: Font.bodySemiBold, color: DARK, letterSpacing: -0.2, marginBottom: 2 },
  ...
  tagEditTxt: { fontSize: 10, color: STONE, fontFamily: Font.bodyMed },
  ...
  fillProfileTxt: { fontSize: 11, color: STONE, fontFamily: Font.bodyMed, letterSpacing: 0.2 },
  ...
  signOutTxt:{ fontSize: 11, color: DIM, fontFamily: Font.bodyMed },
  ...
  reportName: { fontSize: 18, fontFamily: Font.display, color: DARK, letterSpacing: -0.6 },
  reportSub:  { fontSize: 9, color: STONE, letterSpacing: 2.0, textTransform: 'uppercase', marginTop: 3, fontFamily: Font.bodyMed },
  reportDate: { fontSize: 12, color: DARK, fontFamily: Font.bodyMed, textAlign: 'right' },
  ...
  statVal:   { fontSize: 26, fontFamily: Font.display, letterSpacing: -0.8 },
  ...
  reportMole:{ fontSize: 12, color: DARK, fontFamily: Font.bodyMed, letterSpacing: -0.1 },
  ...
  alertTitle:{ fontSize: 12, fontFamily: Font.bodySemiBold, color: '#E8003D', marginBottom: 12 },
  ...
  alertMole: { fontSize: 12, color: DARK, fontFamily: Font.bodyMed, marginBottom: 2 },
  ...
  cardSup:   { fontSize: 9, color: FAINT, letterSpacing: 2, textTransform: 'uppercase', fontFamily: Font.bodyMed, marginBottom: 14 },
  ...
  bkCount:   { fontSize: 12, fontFamily: Font.bodySemiBold, width: 20, textAlign: 'right' },

  notifRow:    { flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 4 },
  notifLabel:  { fontSize: 13, color: DARK, fontFamily: Font.bodyMed, letterSpacing: -0.1 },
  notifSub:    { fontSize: 11, color: FAINT, marginTop: 2 },
  intervalLbl: { fontSize: 10, color: DIM, fontFamily: Font.bodyMed, letterSpacing: 0.4, marginTop: 14, marginBottom: 8 },
  ...
  chipText:    { fontSize: 12, color: DIM, fontFamily: Font.bodyMed },
  ...
  exportTxt: { fontSize: 14, fontFamily: Font.bodySemiBold, color: '#F0EDE8', letterSpacing: 0.3 },
  ...
  modalTitle:    { fontSize: 17, fontFamily: Font.display, color: DARK, letterSpacing: -0.4 },
  modalSub:      { fontSize: 11, color: DIM, marginTop: 4, marginBottom: 18 },
  formLbl:       { fontSize: 9, color: FAINT, letterSpacing: 2, textTransform: 'uppercase', fontFamily: Font.bodyMed, marginBottom: 8 },
  formInput:     { fontSize: 14, color: DARK, fontFamily: Font.bodyMed, borderBottomWidth: 1, borderBottomColor: BORDER, paddingVertical: 8 },
  ...
  formChipTxtOn: { color: '#F0EDE8', fontFamily: Font.bodyMed },
  ...
  modalCancelTxt:{ fontSize: 13, fontFamily: Font.bodyMed, color: DIM },
  modalSave:     { flex: 1, paddingVertical: 13, borderRadius: 0, backgroundColor: DARK, alignItems: 'center' },
  modalSaveTxt:  { fontSize: 13, fontFamily: Font.bodySemiBold, color: '#F0EDE8' },
});
