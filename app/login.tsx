...
import { Font, Palette, hardShadow } from '../constants/theme';
...
const styles = StyleSheet.create({
  ...
  logoOuter:         { width: 72, height: 72, borderRadius: 0, backgroundColor: DARK, alignItems: 'center', justifyContent: 'center', ...hardShadow(4) },
  logoInner:         { width: 30, height: 30, borderRadius: 99, backgroundColor: '#2B3BEF' },
  appName:           { fontFamily: Font.display, fontSize: 32, color: DARK, letterSpacing: -1, marginBottom: 4 },
  tagline:           { fontFamily: Font.mono, fontSize: 10, color: STONE, letterSpacing: 2.2, textTransform: 'uppercase' },
  heroBlock:         { alignItems: 'center', paddingHorizontal: 8 },
  heroTitle:         { fontFamily: Font.display, fontSize: 26, color: DARK, letterSpacing: -0.8, textAlign: 'center', lineHeight: 34, marginBottom: 12 },
  heroSub:           { fontSize: 12, color: FAINT, textAlign: 'center', lineHeight: 18 },
  signInBlock:       { paddingBottom: 8 },
  errorBanner:       { backgroundColor: '#FFF0F3', borderWidth: 1, borderColor: '#FFD0D8', borderRadius: 0, padding: 10, marginBottom: 10 },
