...
const vis = StyleSheet.create({
  ...
  stepNum:      { fontSize: 13, fontFamily: Font.bodySemiBold, color: BG },
  ...
  abcdeLetter:  { fontSize: 22, fontFamily: Font.display, color: DARK },
  ...
  profileLbl:   { fontSize: 9, color: FAINT, letterSpacing: 2.0, textTransform: 'uppercase', fontFamily: Font.bodyMed, marginBottom: 10 },
  profileInput: { fontSize: 16, fontFamily: Font.bodyMed, color: DARK, borderBottomWidth: 1.5, borderBottomColor: BORDER, paddingVertical: 8, paddingHorizontal: 2 },
  ...
  pct:          { fontSize: 13, color: DIM, fontFamily: Font.bodyMed },
  pctA:         { fontSize: 13, color: BG,  fontFamily: Font.bodySemiBold },
...
const s = StyleSheet.create({
  ...
  sup:       { fontSize: 9, color: STONE, letterSpacing: 2.2, textTransform: 'uppercase', fontFamily: Font.bodyMed, marginBottom: 12 },
  title:     { fontSize: 28, fontFamily: Font.display, color: DARK, letterSpacing: -0.8, lineHeight: 36, marginBottom: 14 },
  ...
  btnText:   { fontSize: 16, fontFamily: Font.bodySemiBold, color: BG, letterSpacing: 0.3 },
