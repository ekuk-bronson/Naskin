...
const BG = '#F1EFEA', DARK = '#141412', STONE = '#2B3BEF', DIM = '#6E6C66', FAINT = '#C5BDB4';
...
const s = StyleSheet.create({
  ...
  backLink:        { color: STONE, fontSize: 13, fontFamily: Font.bodyMed },
  topBar:          { flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 20, paddingTop: 10, paddingBottom: 14 },
  backBtn:         { width: 36, height: 36, borderRadius: 0, borderWidth: 1, borderColor: '#EDE9E3', backgroundColor: '#fff', alignItems: 'center', justifyContent: 'center', flexShrink: 0, shadowColor: DARK, shadowOpacity: 0.04, shadowRadius: 6, shadowOffset: { width: 0, height: 2 }, elevation: 1 },
  backBtnTxt:      { color: DIM, fontSize: 16 },
  detailName:      { fontSize: 15, fontFamily: Font.bodySemiBold, color: DARK, letterSpacing: -0.3 },
  ...
  changedChipTxt:  { fontSize: 10, color: '#E06000', fontFamily: Font.bodyMed },
  editBtn:         { width: 34, height: 34, borderRadius: 0, borderWidth: 1, borderColor: '#EDE9E3', backgroundColor: '#fff', alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  ...
  editCancelTxt:   { fontSize: 11, color: DIM, fontFamily: Font.bodyMed },
  editSaveBtn:     { backgroundColor: DARK, borderColor: DARK },
  editSaveTxt:     { fontSize: 11, color: '#F0EDE8', fontFamily: Font.bodySemiBold },
  editCard:        { marginHorizontal: 20, marginBottom: 10, backgroundColor: '#fff', borderWidth: 1, borderColor: '#EDE9E3', borderRadius: 0, padding: 16, shadowColor: DARK, shadowOpacity: 0.04, shadowRadius: 10, shadowOffset: { width: 0, height: 3 }, elevation: 2 },
  editLbl:         { fontSize: 9, color: FAINT, letterSpacing: 2, textTransform: 'uppercase', fontFamily: Font.bodyMed, marginBottom: 8 },
  editInput:       { fontSize: 14, color: DARK, fontFamily: Font.bodyMed, borderBottomWidth: 1, borderBottomColor: '#EDE9E3', paddingVertical: 6 },
  zoneGrid:        { flexDirection: 'row', flexWrap: 'wrap', gap: 7 },
  zoneChip:        { paddingHorizontal: 14, paddingVertical: 7, borderRadius: 0, borderWidth: 1, borderColor: '#EDE9E3', backgroundColor: '#F1EFEA' },
  zoneChipOn:      { borderColor: DARK, backgroundColor: DARK },
  zoneChipTxt:     { fontSize: 11, color: DIM, fontWeight: '500' },
  zoneChipTxtOn:   { color: '#F0EDE8', fontFamily: Font.bodyMed },
  heroPad:         { paddingHorizontal: 20, paddingBottom: 14 },
  heroCard:        { backgroundColor: '#fff', borderRadius: 0, padding: 18, flexDirection: 'row', alignItems: 'center', gap: 14, borderWidth: 1, borderColor: '#EDE9E3', overflow: 'hidden' },
  heroLeft:        { flexShrink: 0 },
  heroMole:        { width: 80, height: 80, borderRadius: 0, borderWidth: 1.5, alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
  heroMoleImg:     { width: '100%', height: '100%' },
  heroMoleDot:     { width: 36, height: 32, borderRadius: 99, backgroundColor: '#2B3BEF' },
  heroLevel:       { fontSize: 24, letterSpacing: -0.8, lineHeight: 28, marginBottom: 6 },
  heroRec:         { fontSize: 12, fontFamily: Font.bodyMed, letterSpacing: 0.1, lineHeight: 16, marginBottom: 8, opacity: 0.85 },
  ...
  heroChangedTxt:  { fontSize: 9, color: '#E06000', fontFamily: Font.bodySemiBold },
  rescanBtn:       { marginHorizontal: 20, marginBottom: 12, paddingVertical: 14, borderRadius: 0, backgroundColor: DARK, alignItems: 'center', shadowColor: DARK, shadowOpacity: 0.18, shadowRadius: 12, shadowOffset: { width: 0, height: 4 }, elevation: 4 },
  rescanTxt:       { fontSize: 13, fontFamily: Font.bodySemiBold, color: '#F0EDE8', letterSpacing: 0.3 },
  tabs:            { flexDirection: 'row', gap: 6, paddingHorizontal: 20, paddingBottom: 12 },
  tabBtn:          { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 0, borderWidth: 1.5, borderColor: '#EDE9E3', backgroundColor: '#fff' },
  ...
  chartCard:       { backgroundColor: '#fff', borderWidth: 1, borderColor: '#EDE9E3', borderRadius: 0, padding: 16, marginBottom: 10, shadowColor: DARK, shadowOpacity: 0.04, shadowRadius: 12, shadowOffset: { width: 0, height: 2 }, elevation: 2 },
  chartHeader:     { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 },
  chartLbl:        { fontSize: 9, color: FAINT, letterSpacing: 2, textTransform: 'uppercase', fontFamily: Font.bodyMed },
  chartCount:      { fontSize: 10, color: STONE, fontFamily: Font.bodyMed, letterSpacing: 0.2 },
  thumbRow:        { flexDirection: 'row', gap: 8, paddingHorizontal: 2 },
  thumb:           { alignItems: 'center', gap: 4 },
  thumbBox:        { width: 52, height: 52, borderRadius: 0, borderWidth: 1.5, alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
  thumbDot:        { width: 22, height: 20, borderRadius: 99 },
  thumbMonth:      { fontSize: 9, color: FAINT, fontWeight: '500' },
  thumbScore:      { fontSize: 11, fontFamily: Font.display },
  compareRow:      { flexDirection: 'row', gap: 10, marginBottom: 12 },
  compareCard:     { flex: 1, borderWidth: 1.5, borderRadius: 0, padding: 14, alignItems: 'center' },
  compareMole:     { width: 52, height: 52, borderRadius: 0, borderWidth: 1.5, alignItems: 'center', justifyContent: 'center', marginBottom: 10, overflow: 'hidden' },
  compareMoleDot:  { width: 22, height: 20, borderRadius: 99 },
  compareMonth:    { fontSize: 10, color: DIM, marginBottom: 4 },
  compareLevel:    { fontSize: 14, fontFamily: Font.display, letterSpacing: -0.3, textAlign: 'center', marginTop: 2 },
  compareStats:    { backgroundColor: '#fff', borderWidth: 1, borderColor: '#EDE9E3', borderRadius: 0, paddingHorizontal: 16, shadowColor: DARK, shadowOpacity: 0.03, shadowRadius: 8, shadowOffset: { width: 0, height: 2 }, elevation: 1 },
  ...
  compareStatVal:  { fontSize: 13, fontFamily: Font.bodySemiBold },
